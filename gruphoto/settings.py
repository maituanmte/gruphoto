...
ADMIN_STATIC_ROOT = os.path.join(STATIC_ROOT, 'admin')
...
STATICFILES_DIRS = (
    os.path.join(ADMIN_STATIC_ROOT, 'css'),
    os.path.join(ADMIN_STATIC_ROOT, 'js'),
    os.path.join(ADMIN_STATIC_ROOT, 'img'),
...
MIDDLEWARE_CLASSES = (
    ...
    'gauth.middleware.GSessionMiddleware',
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_PATH, 'testform/templates'),
